export class AI{
    _constructor(){
        ...
        this.uri = "mongodb+srv://fluffypanda:thefluffa5@humanityagainstcards-vfnzh.gcp.mongodb.net/test?retryWrites=true&w=majority";
        
    }
    async getAiAnswer(black_card, white_cards) {
        var client;
        try {
            client = await this.MongoClient.connect(this.uri,{ useNewUrlParser: true, useUnifiedTopology: true });
